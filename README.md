...
- 🧠 Currently mastering Bloc, Clean Architecture & performance optimization
...
| 🏋 Fitness          | Workout tracking app using GetX & Firebase                                     |
| 📋 Todo             | CRUD application with Provider & Firebase Authentication                       |
| 🔐 Authentication   | Multi-provider authentication using Firebase                                   |
| 🛎 Service Provider | Clean Architecture based service booking application                           |
...
|-------------------|---------------|---------------|-------------------|
| ✨ Clean Code | 📚 Continuous Learner | ❤️ User-Focused | 🚀 Growth Mindset |
...
- 💼 Flutter Developer
- 🎓 BSc CSIT Graduate
- 🌱 Currently learning Clean Architecture & Advanced Flutter
